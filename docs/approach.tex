...
is any reduction in CANS effects due to there being a shorter time
for diffusion to occur. ?(A guess) However, we expect that CANS effects would be
small compared to the error from shorter observation time and that a
better approach would be to correct for CANS in CMS data either
