...
def comparePosteriors(M1,M2,sim,main="",lab1="",lab2="",lwd=2,show=False):
    ...
    ax[0].set_xlabel('r')
    ax[0].axvline(sim.r_true,linestyle="dashed",color="black",label="True value",lw=lwd)
    ...
    ax[1].set_xlabel('K')
    ax[1].axvline(sim.K_true,linestyle="dashed",color="black",label="True value",lw=lwd)
    ax[1].legend()
    plt.suptitle(main)
    if show:
        plt.show()

def posteriorPriorPlots(M,sim,par,bnum=50,show=True,main="",lwd=2):
    ...
    if 'x0' in nodenames: 
        ...
        ax[0,2].axvline(sim.x0_true,linestyle="dashed",color="black",lw=lwd)
    ...
    ax[1,0].axvline(sim.r_true,linestyle="dashed",color="black",lw=lwd)
    ...
    ax[1,1].axvline(sim.K_true,linestyle="dashed",color="black",lw=lwd)
    ...
    ax[1,2].axvline(sim.tau_true,linestyle="dashed",color="black",lw=lwd)
    plt.suptitle(main)
    if show:
        plt.show()
